...
public class AlipayControllerme {
...
private MyInsuranceService MyInsuranceService;
	 ...
	 */
	@RequestMapping("/pay")
	public void pay(HttpServletRequest request, HttpServletResponse response,String money,String policyNumber) throws Exception {
		System.out.println("money="+money+"..."+"policyNumber="+policyNumber);	
	...
	public String returnUrl(HttpServletRequest request) throws Exception {
		...
		MyInsuranceService.changePolicyStatuSid(policyNumber);
		//通过保单号查询保单ID
		Integer policyId = MyInsuranceService.getPolicyIdByPolicyNumber(policyNumber) ;
		//保存保单ID到审核表
		MyInsuranceService.addCheckInfo(policyId) ;
		return "redirect:/foreground/my-insurance.html";
		} 		
		else {
